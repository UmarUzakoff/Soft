...
export default function Footer() {
  return (
    <footer className="relative container overflow-hidden z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
      <div className="container mx-5 md:mx-7 xl:mx-28">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <a
                  href="##"
                  className="text-dark hover:bg-emerald-200 hover:border-emerald-200 mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                  <svg
                    width="8"
                    height="16"
                    viewBox="0 0 8 16"
              ...
              <p className="text-body-color text-base">&copy; 2023 Soft</p>
            </div>
          </div>
        </div>
      </div>
